...
#define V1495_PATTERNUNIT_VMEFPGAFWVERSION_MAJORNUMBER_BITMASK 0xFF
#define V1495_PATTERNUNIT_VMEFPGAFWVERSION_MINORNUMBER_BITMASK 0xFF

#define V1495_PATTERNUNIT_USERFPGA_FWVERSION_ADDRESS 0x100C
#define V1495_PATTERNUNIT_USERFPGAFWVERSION_MAJORNUMBER_BITMASK 0xF
#define V1495_PATTERNUNIT_USERFPGAFWVERSION_MINORNUMBER_BITMASK 0xF
